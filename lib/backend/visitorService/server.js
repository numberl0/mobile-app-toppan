...
app.get(`${pipe}/getAgreement`, authenticateToken, async (req, res, next) => {
  try {
...
//Get role user
app.get(`${pipe}/getRoleByUser`, authenticateToken, async (req, res, next) => {
  try {
...
//Get role building
app.get(`${pipe}/getBuilding`, authenticateToken, async (req, res, next) => {
  try {
...
// Get role manage
app.get(`${pipe}/getManagerRole`, authenticateToken, async (req, res, next) => {
  try {
...
//Get sequence running number
app.get(`${pipe}/getSequenceRunning`, authenticateToken, async (req, res, next) => {
  try {
...
app.get(`${pipe}/getSignaturFilenameByUsername`, authenticateToken, async (req, res, next) => {
  try {
    const { username } = req.query;
    if(!username) {
...
app.get(`${pipe}/getRequestFormByDate`, authenticateToken, async (req, res, next) => {
  try {
...
app.get(`${pipe}/getRequestApproved`, authenticateToken, async (req, res, next) => {
  try {
...
//
app.get(`${pipe}/checkRecordFCM`, authenticateToken, async (req, res, next) => {
  try {
...
// ---------------------------------------------- Checker ---------------------------------------------- //
app.get(`${pipe}/passRequestDoesNotExist`, authenticateToken, async (req, res, next) => {
  try {
...
// ---------------------------------------------- Insert Table ---------------------------------------------- //
// Insert Pass Form 
app.post(`${pipe}/uploadPassForm`, authenticateToken, async (req, res, next) => {
  try {
    const data = req.body;
...
// Insert Pass Request
app.post(`${pipe}/uploadPassRequest`, authenticateToken, async (req, res, next) => {
  try {
    const data = req.body;
...
// Insert Activity Log
app.post(`${pipe}/insertActivityLog`, authenticateToken, async (req, res, next) => {
  try {
    const data = req.body;
...
// Insert FCM Token
app.post(`${pipe}/insertFCMToken`, authenticateToken, async (req, res, next) => {
  try {
    const data = req.body;
...
// ---------------------------------------------- Update Table ---------------------------------------------- //
//Get sequence running number
app.post(`${pipe}/updateSequenceRunning`, authenticateToken, async (req, res, next) => {
  try {
...
// Update Pass Form 
app.post(`${pipe}/updatePassForm`, authenticateToken, async (req, res, next) => {
  try {
    const { data } = req.body;
    const structuredData = {
      tno_pass: data.tno_pass,
...
// Update Pass Request
app.post(`${pipe}/updatePassRequest`, authenticateToken, async (req, res, next) => {
  try {
    const {data} = req.body;
...
app.post(`${pipe}/approvedDocument`, authenticateToken, async (req, res, next) => {
  try {
...
app.post(`${pipe}/approvedAll`, authenticateToken, async (req, res, next) => {
  try {
...
app.post(`${pipe}/updateActiveFCMToken`, authenticateToken, async (req, res, next) => {
  try {
...
// ---------------------------------------------- Delete ---------------------------------------------- //
app.delete(`${pipe}/deleteFCMToken`, authenticateToken, async (req, res, next) => {
  try {
...
const upload = multer({ 
  ...
  fileSize: 10 * 1024 * 1024 // Limit each file size to 10 MB (adjust as needed)
  } 
});
...
function convertFilenameToUrl(filename, folder) {
  ...
  return `${domain}/${pipe.isNotEmpty ? pipe : visitorConfig.harderIp}/loadImages/${folder}/${filename}`;    // This line is link to load image directory
}
