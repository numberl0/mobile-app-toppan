...
class ServiceManager {
  ...
  Future<void> preparePermissionsServices() async {
    ...
    {'key': 'permis', 'label': 'เบิกบัตร', 'description': 'ใบคำร้องกรณีบัตรหาย/ชำรุด', 'icon': Icons.add_card_rounded, 'enable': true, 'notify': false},
    ...
    {'key': 'partTime', 'label': 'พาร์ทไทม์', 'description': 'พนักงานชั่วคราวและอื่นๆ', 'icon': Icons.av_timer_rounded, 'enable': true, 'notify': false},
